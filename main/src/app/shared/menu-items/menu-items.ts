...
const MENUITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { state: 'timelog-summary', name: 'Timelog Summary' },
  ...
  //     { state: 'radiobutton', name: 'Radio Button' },
  //     { state: 'datepicker', name: 'Datepicker' },
  //     { state: 'formfield', name: 'Form Field' },
  //     { state: 'input', name: 'Inputs' },
  ...
  //     { state: 'sortheader', name: 'Sort Header' },
  //   ]
  // },
  // {
  //   state: 'tables',
